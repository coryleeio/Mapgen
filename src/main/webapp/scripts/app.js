...
var mapgenApp = angular.module('mapgenApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'mapgenAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
